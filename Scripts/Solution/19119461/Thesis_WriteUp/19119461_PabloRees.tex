...
\begin{abstract}
\small{
The literature relating textual to stock market data is deep, but the
relationship between speeches given by political figures and stock
markets is relatively undefined. This research begins to rectify this by
...
prediction accuracy of about 60\% over an S\&P 500 index price movement
proxy. This is an increase of about 0.3\% (0.599 vs 0.601) over the
models that did not include the presidential speech data (without losing
ground in either recall or precision). Notably, this result was drawn
from 71 years of data at a daily resolution. Thus, it is concluded that
presidential speeches hold predictive power over stock market movements
and that this relationship can be used to improve the power of
predictive models.
}
\end{abstract}
...
\addcontentsline{toc}{section}{Appendix A: Machine Learning Model
...
\addcontentsline{toc}{subsection}{A.1. Regression Algorithm
Hyper-Parameters}
...
\addcontentsline{toc}{subsection}{A.2. Classification Algorithm
Hyper-Parameters}
...
\addcontentsline{toc}{subsection}{A.3. Datasets and variables}
...
\addcontentsline{toc}{subsection}{A.4. Hyper-parameter tuning for TS
...
\addcontentsline{toc}{subsubsection}{A.4.1. Time series classification
...
\addcontentsline{toc}{subsubsection}{A.4.2. Time series classification
